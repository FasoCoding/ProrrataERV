...
WHERE t_collection.collection_id = 1 AND t_property.name IN ('Generation', 'Units Generating', 'Capacity Curtailed', 'Max Capacity', 'Available Capacity') AND t_category.category_id IN (95, 96, 99, 100) AND t_period_0.interval_id <= 24;
